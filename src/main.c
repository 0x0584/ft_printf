...
int main(void)
{
	...
	*/
	...
	char *fmt = "[left (%e) (%.3e) (%.4e) (%+10.8f) (%.2f) (% f)]\n";
	ft_printf(fmt, 89.999, 89.999, 0.0001343453, 89.999, 89.999, 0.0999);
	ft_putendl("------------------------");
	printf(fmt, 89.999, 89.999, 0.0001343453, 89.999, 89.999, 0.0999);
